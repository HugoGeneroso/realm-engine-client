...
const DUPE_ITEMS: MarketDupeItem[] = [
  { id: 1, name: 'Attack Potion',    icon: '⚔️', objectType: 0x2368, tiers: [{ qty: 1, priceGems: 0 }, { qty: 5, priceGems:  72 }, { qty: 10, priceGems: 136 }, { qty: 20, priceGems: 256 }, { qty: 50, priceGems: 0 }, { qty: 100, priceGems: 0 }] },
  { id: 2, name: 'Defense Potion',   icon: '🛡️', objectType: 0x2369, tiers: [{ qty: 1, priceGems: 0 }, { qty: 5, priceGems:  72 }, { qty: 10, priceGems: 136 }, { qty: 20, priceGems: 256 }, { qty: 50, priceGems: 0 }, { qty: 100, priceGems: 0 }] },
  { id: 3, name: 'Speed Potion',     icon: '💨', objectType: 0x236a, tiers: [{ qty: 1, priceGems: 0 }, { qty: 5, priceGems:  72 }, { qty: 10, priceGems: 136 }, { qty: 20, priceGems: 256 }, { qty: 50, priceGems: 0 }, { qty: 100, priceGems: 0 }] },
  { id: 4, name: 'Dexterity Potion', icon: '🏹', objectType: 0x236d, tiers: [{ qty: 1, priceGems: 0 }, { qty: 5, priceGems:  72 }, { qty: 10, priceGems: 136 }, { qty: 20, priceGems: 256 }, { qty: 50, priceGems: 0 }, { qty: 100, priceGems: 0 }] },
  { id: 5, name: 'Vitality Potion',  icon: '❤️', objectType: 0x236b, tiers: [{ qty: 1, priceGems: 0 }, { qty: 5, priceGems:  72 }, { qty: 10, priceGems: 136 }, { qty: 20, priceGems: 256 }, { qty: 50, priceGems: 0 }, { qty: 100, priceGems: 0 }] },
  { id: 6, name: 'Wisdom Potion',    icon: '🔮', objectType: 0x236c, tiers: [{ qty: 1, priceGems: 0 }, { qty: 5, priceGems:  72 }, { qty: 10, priceGems: 136 }, { qty: 20, priceGems: 256 }, { qty: 50, priceGems: 0 }, { qty: 100, priceGems: 0 }] },
